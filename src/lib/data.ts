...
export const footerLinks = {
  shop: [
    ...
    { label: 'King Size Mattresses', href: '/mattresses?size=king' },
    { label: 'Queen Size Mattresses', href: '/mattresses?size=queen' },
    { label: 'Full Size Mattresses', href: '/mattresses?size=full' },
    { label: 'Twin Size Mattresses', href: '/mattresses?size=twin' },
    { label: 'Compare Mattresses', href: '/compare' },
    { label: 'Mattress Finder Quiz', href: '/quiz' },
  ],
  discounts: [
    { label: 'Military Discount', href: '/discounts/military' },
    { label: 'First Responders Discount', href: '/discounts/first-responders' },
    { label: 'Healthcare Professional Discount', href: '/discounts/healthcare' },
  ],
  support: [
  ...
  resources: [
    { label: 'Sleep Calculator', href: '/sleep-calculator' },
    { label: 'Mattress Size Guide', href: '/mattress-size-guide' },
    { label: 'Mattress Buying Guide', href: '/buying-guide' },
    { label: 'Side Sleeper Guide', href: '/side-sleeper' },
    { label: 'Better Sleep Blog', href: '/blog' },
  ],
};
